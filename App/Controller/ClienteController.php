 ...
 */
    ...
    class ClienteController {
        ...
        public function cadastrarCliente($dados) {
            ...
            $stmt = $conexao->prepare('INSERT INTO cliente(cpf, Nome, email, senha, dataNascimento, endereco, numero, complemento, estado, cep) VALUES(:ecpf, :eNome, :eemail, :esenha, :edataNascimento, :eendereco, :enumero, :ecomplemento, :eestado, :ecep);');
            ...
            $stmt->bindParam(':enumero', $dados['numero']);
            $stmt->bindParam(':ecomplemento', $dados['complemento']);
            $stmt->bindParam(':eestado', $dados['estado']);
            $stmt->bindParam(':ecep', $dados['cep']);
            $result =  $stmt->execute();
            return $result;
        }
