      ...
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <form action="#" method="post">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-lg-12">
                  <input type="submit" class="btn btn-primary btn-lg btn-block" value="Envia Mensagem">
                </div>
              </div>
            </div>
          </form>
        ...
        <div class="col-md-5 ml-auto">
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase">São Paulo</span>
            <p class="mb-0">Av. Eng. Eusébio Stevaux, 823 - Santo Amaro, São Paulo - SP, 04696-000</p>
          </div>
        </div>
      </div>
    </div>
