        ...
        <table cellspacing="0" cellpadding="0" border="1">
            <tr>
                ...
                <td width="30%">
                    ...
                    <br/>
                    <br/>
                    <p class="content right text" style="font-weight:bold;">15/11/2019</p>
                </td>
            </tr>
            <tr>
                <td width="70%" colspan="6">
            ...
            <tr>
                <td width="15%">
                    ...
                    <br/>
                    <p class="content center">05/11/2019</p>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                    <p class="content center">7.150,00</p>
                </td>
                <td width="30%">
                    <span class="title">(=) Valor do Documento</span>
                    <br/>
                    <br/>
                    <p class="content right">7.150,00</p>
                </td>
            </tr>
            <tr>
