...
<body>
  ...
  $frete = calculaFrete($cep);
  $freteValor = str_replace(",",".", $frete['valor']);
    ?>
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          ...
          <div class="p-3 p-lg-5 border">
            ...
            <div class="form-group row">
              <div class="col-md-6">
                <form method="POST" action="" id="c_frete" class="col-md-12" style="padding: 0;">
            ...
            <div class="form-group">
              ...
              <div class="collapse" id="ship_different_endereco">
                <div class="py-2">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <form method="POST" action="" id="c_diff_frete" class="col-md-12" style="padding: 0;">
                ...
                <table class="table site-block-order-table mb-5">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-black">R$ <?php echo number_format($subtotal,2,",",".");?></td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Frete</strong></td>
                      <td class="text-black" id="frete">R$ <?php echo $freteValor; ?></td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Total</strong></td>
                      <td class="text-black font-weight-bold"><strong>R$ <?php echo number_format($total,2,",",".");?></strong></td>
                    </tr>
                  </tbody>
                </table>
